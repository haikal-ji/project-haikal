...
export default function TechIcon({ name, className = 'w-8 h-8' }: TechIconProps) {
  ...
  if (norm.includes('react native') || norm.includes('react-native')) {
    return (
      <svg aria-hidden="true" className={className} viewBox="-11.5 -10.23174 23 20.46348" fill="currentColor">
  ...
  if (norm.includes('docker')) {
    return <SiDocker aria-hidden="true" className={`${className} text-[#2496ED]`} />;
  }

  if (norm.includes('next')) {
    return (
      <svg aria-hidden="true" className={className} viewBox="0 0 128 128" fill="none">
  ...
  if (norm.includes('typescript')) {
    return (
      <svg aria-hidden="true" className={className} viewBox="0 0 128 128">
  ...
  if (norm.includes('postgres')) {
    return <SiPostgresql aria-hidden="true" className={`${className} text-[#336791]`} />;
  }

  if (norm.includes('figma')) {
    return (
      <svg aria-hidden="true" className={className} viewBox="0 0 38 57" fill="none">
  ...
  if (norm.includes('git') && !norm.includes('hub')) {
    return (
      <svg aria-hidden="true" className={className} viewBox="0 0 24 24" fill="#F05032">
  ...
  if (norm.includes('vs code') || norm.includes('vscode')) {
    return (
      <svg aria-hidden="true" className={className} viewBox="0 0 24 24" fill="#007ACC">
